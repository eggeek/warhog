#pragma once
// online_jump_point_locator_prune2.h
//
...
class online_jump_point_locator_prune2 
{
	public: 
		online_jump_point_locator_prune2(gridmap* map, online_jps_pruner* pruner, blocklist* np);
