#include "gridmap.h"
#include "jps.h"
#include "online_jump_point_locator_simple.h"

#include <cassert>
#include <climits>

warthog::online_jump_point_locator_simple::online_jump_point_locator_simple(warthog::gridmap* map)
	: map_(map)//, jumplimit_(UINT32_MAX)
{
	rmap_ = create_rmap();
}

warthog::online_jump_point_locator_simple::~online_jump_point_locator_simple()
{
	delete rmap_;
}
...
warthog::gridmap*
warthog::online_jump_point_locator_simple::create_rmap()
{
...
void
warthog::online_jump_point_locator_simple::jump(warthog::jps::direction d,
...
void
warthog::online_jump_point_locator_simple::jump_north(uint32_t node_id, 
...
void
warthog::online_jump_point_locator_simple::__jump_north(uint32_t node_id, 
		uint32_t goal_id, uint32_t& jumpnode_id, warthog::cost_t& jumpcost,
...
void
warthog::online_jump_point_locator_simple::jump_south(uint32_t node_id, 
		uint32_t goal_id, uint32_t& jumpnode_id, warthog::cost_t& jumpcost)
{
	node_id = this->map_id_to_rmap_id(node_id);
	goal_id = this->map_id_to_rmap_id(goal_id);
...
void
warthog::online_jump_point_locator_simple::__jump_south(uint32_t node_id, 
		uint32_t goal_id, uint32_t& jumpnode_id, warthog::cost_t& jumpcost,
		warthog::gridmap* mymap)
{
	// jumping north in the original map is the same as jumping
...
void
warthog::online_jump_point_locator_simple::jump_east(uint32_t node_id, 
		uint32_t goal_id, uint32_t& jumpnode_id, warthog::cost_t& jumpcost)
{
...
void
warthog::online_jump_point_locator_simple::__jump_east(uint32_t node_id, 
		uint32_t goal_id, uint32_t& jumpnode_id, warthog::cost_t& jumpcost, 
		warthog::gridmap* mymap)
{
	jumpnode_id = node_id;
...
void
warthog::online_jump_point_locator_simple::jump_west(uint32_t node_id, 
		uint32_t goal_id, uint32_t& jumpnode_id, warthog::cost_t& jumpcost)
{
...
void
warthog::online_jump_point_locator_simple::__jump_west(uint32_t node_id, 
		uint32_t goal_id, uint32_t& jumpnode_id, warthog::cost_t& jumpcost, 
		warthog::gridmap* mymap)
{
	bool deadend = false;
...
void
warthog::online_jump_point_locator_simple::jump_northeast(uint32_t node_id,
	   	uint32_t goal_id, uint32_t& jumpnode_id, warthog::cost_t& jumpcost)
{
...
void
warthog::online_jump_point_locator_simple::jump_northwest(uint32_t node_id, 
		uint32_t goal_id, uint32_t& jumpnode_id, warthog::cost_t& jumpcost)
{
	uint32_t num_steps = 0;
...
void
warthog::online_jump_point_locator_simple::jump_southeast(uint32_t node_id, 
		uint32_t goal_id, uint32_t& jumpnode_id, warthog::cost_t& jumpcost)
{
	uint32_t num_steps = 0;
...
void
warthog::online_jump_point_locator_simple::jump_southwest(uint32_t node_id, 
		uint32_t goal_id, uint32_t& jumpnode_id, warthog::cost_t& jumpcost)
{
	uint32_t num_steps = 0;
