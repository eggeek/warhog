#pragma once
// online_jump_point_locator_simple.h
//
...
class online_jump_point_locator_simple 
{
	public: 
		online_jump_point_locator_simple(warthog::gridmap* map);
		~online_jump_point_locator_simple();
    uint32_t scan_cnt;
