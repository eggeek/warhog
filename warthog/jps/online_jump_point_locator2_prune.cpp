...
using JPL2 = warthog::online_jump_point_locator2_prune;

JPL2::online_jump_point_locator2_prune(warthog::gridmap* map)
...
JPL2::~online_jump_point_locator2_prune()
{
	delete rmap_;
}
...
void
JPL2::jump(warthog::jps::direction d,
...
void
JPL2::__jump_north(uint32_t node_id, 
...
void
JPL2::__jump_south(uint32_t node_id, 
		uint32_t goal_id, uint32_t& jumpnode_id, warthog::cost_t& jumpcost,
		warthog::gridmap* mymap)
{
	// jumping north in the original map is the same as jumping
...
void
JPL2::__jump_east(uint32_t node_id, 
		uint32_t goal_id, uint32_t& jumpnode_id, warthog::cost_t& jumpcost, 
		warthog::gridmap* mymap)
{
	jumpnode_id = node_id;
...
void
JPL2::__jump_west(uint32_t node_id, 
		uint32_t goal_id, uint32_t& jumpnode_id, warthog::cost_t& jumpcost, 
		warthog::gridmap* mymap)
{
	bool deadend = false;
