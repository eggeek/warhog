...
class jps_expansion_policy_simple 
{
	public:
		jps_expansion_policy_simple(warthog::gridmap* map);
		~jps_expansion_policy_simple();
    ...
    warthog::online_jump_point_locator_simple* get_locator() {
      return this->jpl_;
    }
    ...
    int subcnt_touch = 0;
    void clear_cnt() {
      subcnt_expd = subcnt_touch = 0;
    }

	private:
		warthog::gridmap* map_;
		warthog::blocklist* nodepool_;
		warthog::online_jump_point_locator_simple* jpl_;
		uint32_t which_;
